...
// Changed to w_stdint and added DLLAPI
//#include <stdint.h>
#include "Defines.h"
#include "w_stdint.h"
...
DLLAPI uint32_t little_to_middle(uint32_t x);
DLLAPI uint32_t reverse_endian32(uint32_t x);
DLLAPI uint32_t invert_bytes(uint32_t x);
DLLAPI uint32_t rev_bendian32(uint32_t x);
DLLAPI uint16_t reverse_endian16(uint16_t x);
DLLAPI uint16_t invert_inner16(uint16_t x);
DLLAPI uint16_t invert_outer16(uint16_t x);
DLLAPI uint16_t flipbyte16(uint16_t x);
DLLAPI uint8_t flipbyte(uint8_t x);
